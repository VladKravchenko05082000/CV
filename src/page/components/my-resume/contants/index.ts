export const WORK_EXPERIENCE_LIST = [
  ...
  },
  {
    ...
    text: "Over 1.5 years, I worked on developing the blockchain project, significantly enhancing my front-end development skills. As a result of this experience, I advanced to the level of a middle developer.",
  },
  {
    title: "Middle Front-end Developer",
    timePeriod: "Idealogic - 16.09.2023 - 20.05.2024",
    text: "I have successfully completed work on the crypto platform project and moved on to working on internal company projects. This experience has allowed me to gain a deeper understanding of fundamental aspects of development.",
  },
];
